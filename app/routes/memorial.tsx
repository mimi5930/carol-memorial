...
export default function Memorial() {
  return (
    <>
      <PageHeader>The Carol Trainor Memorial Fund</PageHeader>
      <section className="flex flex-col items-center py-6 sm:py-8 px-4">
        <article className="flex flex-col gap-6 sm:gap-10 w-full max-w-7xl text-base sm:text-lg bg-slate-50 rounded-md p-4 sm:p-8 shadow-md pb-12 sm:pb-24">
          ...
          <p>
            ...
            commitment to those around her. In November 2024, Carol&apos;s
            health began to rapidly decline, and she was admitted to Fairview
            Hospital, where she began a battle against a series of mysterious
            medical challenges. Despite numerous tests and treatments, doctors
            were unable to pinpoint a definitive diagnosis. The medical
            community was left grasping for answers as Carol suffered from brain
            seizures, episodes that impacted her daily life in ways no one could
            have foreseen. Through each step of this unknown journey, Carol
            remained a pillar of strength. She continued to fight with grace.
            Her dedication to her family and her community never wavered, even
            as she faced this terrifying health crisis.
          </p>
          ...
          <p>
            ...
            and the unwavering dedication of her family became the foundation
            for her strength. Her husband, Chad, stood by her side through every
            hospital visit, late-night stay, and moment of fear. Their bond was
            a source of unspoken comfort, a steady presence in the face of
            uncertainty.
          </p>
          <p>
          ...
          <p>
            ...
            loved ones, providing support in any way they could. From donations
            to emotional encouragement, the community&apos;s response was a
            testament to the mark Carol had left on those around her. As a key
            figure at Urban Olive and Vine, Carol was more than just a familiar
            face; she was a friend, mentor, and pillar of the community. Her
            kindness, work ethic, and dedication to helping others made her a
            beloved member of Hudson. As her health took its toll, this same
            community stepped up to help Carol and her family with the same love
            and generosity Carol had always shown them.
          </p>

          <h3 className="text-2xl sm:text-3xl font-bold">
            A Memorial Fund to Continue Carol&apos;s Legacy of Care and
            Compassion
          </h3>
          <p>
            In honor of Carol&apos;s life and the profound impact she had on
            those around her, her family has chosen to establish this memorial
            fund as a way to give back to the community that supported her so
            ...
            impact—just as Carol did—by helping people in need, offering them
            the support and resources they need to navigate difficult medical
            journeys.
          </p>
          <p>
            Carol&apos;s story is one of strength, but also one of
            vulnerability. Her family&apos;s unwavering support and the
            community&apos;s outpouring of love during her time of need
            exemplify the power of compassion. This memorial fund aims to carry
            on that legacy, providing hope and assistance to those who find
            themselves in the midst of an uncertain medical journey, just as
            Carol did.
          </p>
          ...
          <p>
            As we remember Carol Trainor and celebrate her life, we also
            recognize the profound influence she had on her family, friends, and
            community. The funds raised will ensure that Carol&apos;s compassion
            and generosity continue to touch lives for years to come. This
            memorial fund is not just a way to honor her memory—it is a way to
            continue her work of lifting others up and making a difference.
          </p>
          <p>
            We invite you to join us in this mission of love, support, and
            community care by contributing to the Carol A. Trainor Memorial
            Fund. Together, we can ensure that Carol&apos;s legacy of care and
            kindness lives on, offering hope and assistance to those in need in
            Hudson and beyond.
          </p>
